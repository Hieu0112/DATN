...
**3.1, Data_Collect: Thu thập dữ liệu trên github và code lấy dữ liệu từ các trang web**
- DataEnglish
...
**3.6, Evaluate: Tính toán các độ đo PPV, TPR, ACC, F1, FPR, FNR.<br>**
**3.7, Model: Lưu trữ các model ban đầu.<br>**
**3.8, Predict: Lưu trữ dự đoán thực thế sau khi xây dựng.<br>**
**3.9, AppDetection.<br>**
- Phát hiện tin giả: bằng tiếng anh và tiếng việt .
- Những thuật toán cuối cùng lựa chọn.
**3.10, Vector: Lưu trữ vector hóa ngôn ngữ.<br>**
